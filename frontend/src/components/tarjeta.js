...
export const tarjeta = (todo,num) =>{
    ...
    $tarjeta.classList.add("w-80","min-h-20","bg-gray-200","shadow-md","text-center","text-2xl","rounded-lg","escondio","flex",)
    $tarjeta.style= "filter:blur(3px); transform: translateY(200%)"
    
    const $tarjetaTitulo = document.createElement("h1")
    $tarjetaTitulo.classList.add("text-no-wrap","truncate","overflow-hidden","mx-10")
